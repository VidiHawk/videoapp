...
export function matchUrlStructure(routeMatch, url, reduxState){
	let returnObj = {isMatch: true, isArticle: false}
  return returnObj;
}
...
export function thirdPartyAnalytics(request, lang, isMobile){
  return '';
}
