...
const useInViewport = (target, options, config = { disconnectOnLeave: false }, props) => {
  ...
  useEffect(() => {
    ...
    function handleIntersection(entries) {
      ...
      const isInViewport = typeof isIntersecting !== 'undefined' && intersectionRatio > 0.85
      let isInBetween = typeof isIntersecting !== 'undefined' && intersectionRatio > 0.2 && intersectionRatio < 0.85
