...
class UserBasicInfo extends AbsractRedis{
  ...
  */
  async save(userId, options = {}){
    ...
    options[HASH_FIELDS.AVATAR] && (_toAdd[HASH_FIELDS.AVATAR] = options[HASH_FIELDS.AVATAR]);
    ...
    return new Promise((resolve, reject) => {
      ...
      super.asyncHgetall(_key).then(userData=>{
        const userDetails = userData ? {
          ...
          [HASH_FIELDS.AVATAR]: userData[HASH_FIELDS.AVATAR],
  ...
  */
  async updateUser(userId, options = {}){
    ...
    if(options[HASH_FIELDS.AVATAR]) _toUpdate[HASH_FIELDS.AVATAR] = options[HASH_FIELDS.AVATAR];
